...
public class MCH_ItemContainer extends W_Item
{
    ...
    public ItemStack func_77659_a(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer) {
        ...
        if (W_MovingObjectPosition.isHitTypeTile(movingobjectposition)) {
            ...
            final MCH_EntityContainer entityboat = new MCH_EntityContainer(par2World, i + 0.5f, j + 1.0f, k + 0.5f);
            entityboat.field_70177_z = ((MathHelper.func_76128_c(par3EntityPlayer.field_70177_z * 4.0f / 360.0f + 0.5) & 0x3) - 1) * 90;
